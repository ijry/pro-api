...
`,[x("scrollbar",`
 ...
 `)]),P("render-label",`
 color: var(--n-text-color);
 `)]),Qe("disabled",[te("&:hover",[P("state-border",`
 ...
 opacity: 0;
 `)]),["warning","error"].map(e=>U(`${e}-status`,[P("state-border",`border: var(--n-border-${e});`),Qe("disabled",[te("&:hover",[P("state-border",`
