...
> :construction: This page is not translated yet. Please refer to the [Chinese version](/zh/api/openai-compat) for now. Full English translation is planned for **M2**.
