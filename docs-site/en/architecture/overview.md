...
> :construction: This page is not translated yet. Please refer to the [Chinese version](/zh/architecture/overview) for now. Full English translation is planned for **M2**.
